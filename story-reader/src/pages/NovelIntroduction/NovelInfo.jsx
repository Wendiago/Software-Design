      ...
      <Paper className={classes.paper}>
        <Grid container spacing={2}>
          <Grid item xs={12} sm={4}>
            <img src={novel.image} alt="Book Cover" className={classes.image} />
              ...
              <div>
                ...
                {genresList?.map((category, index) => (
                  <span
                    ...
                    style={{ cursor: 'pointer' }}
                  >
                    &nbsp;{category}{index < genresList.length - 1 ? ',' : ''}
                  </span>
                ))}
              </div>
              <div>
          ...
          <Grid item xs={12} sm={8} className={classes.details}>
            <Typography variant="h4" className={classes.title}>{novel.title}</Typography>
            <Box className={classes.rating}>
              <Rating value={novel.rating/2} readOnly />
              <Typography variant="body2" component="span" style={{ marginLeft: 8 }}>{novel.rating}/10</Typography>
            </Box>
