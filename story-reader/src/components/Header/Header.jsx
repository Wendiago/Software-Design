...
import {
  ...
  FaPlus,
  FaMinus,
} from "react-icons/fa"; // Import the setting icon from react-icons library
import {
  AppBar,
  Toolbar,
  IconButton,
...
const Header = ({ selectedTheme, toggleTheme }) => {
  ...
  useEffect(() => {
    ...
    const initialFontSize = storedFontSize
      ? parseInt(storedFontSize)
      : baseFontSize;
            ...
            <div style={{ textAlign: "left" }}>
                              ...
                              <TableRow key={index}>
                                ...
                                {category[index + 1] && (
                                  <TableCell
                                    ...
                                    onClick={() =>
                                      handleCategory(category[index + 1].id)
                                    }
                                  >
                                ...
                                {category[index + 2] && (
                                  <TableCell
                                    ...
                                    onClick={() =>
                                      handleCategory(category[index + 2].id)
                                    }
                                  >
                                    {category[index + 2].name}
                                  </TableCell>
                                )}
                                {category[index + 3] && (
                                  <TableCell
                                    ...
                                    onClick={() =>
                                      handleCategory(category[index + 3].id)
                                    }
                                  >
                                    {category[index + 3].name}
                                  </TableCell>
                                )}
                              </TableRow>
                            )
              ...
              <div style={{ flexGrow: 1, marginLeft: "10px" }}>
                ...
                {showSetting && (
                  <div
                    id="setting-menu"
                    style={{ visibility: "visible", marginLeft: "20px" }}
                  >
                    <Toolbar>
                      <span>Cỡ chữ:</span>
                      <div
                      ...
                      >
                        ...
                        <IconButton
                          size="small"
                          style={{ background: "white", marginLeft: "3px" }}
